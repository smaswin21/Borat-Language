...
token_T* lexer_collect_id(lexer_T* lexer)
{
    ...
    while (isalnum(lexer->c) || lexer->c == ' ' || lexer->c == ',' || lexer->c == '?' || lexer->c == '!')
    {
        char* s = lexer_get_current_char_as_string(lexer);
        value = realloc(value, (strlen(value) + strlen(s) + 1) * sizeof(char));
        strcat(value, s);
    ...
    if (strcmp(value, "Suck!") == 0)
        return init_token(TOKEN_VAR, value); // TOKEN_VAR for "var"
    if (strcmp(value, "Hey, what your name?") == 0)
        return init_token(TOKEN_IF, value); // TOKEN_IF for "if"
    if (strcmp(value, "Who you with?") == 0)
        return init_token(TOKEN_ELSE, value); // TOKEN_ELSE for "else"
    if (strcmp(value, "Uh, you mean to the restroom?") == 0)
        return init_token(TOKEN_WHILE, value); // TOKEN_WHILE for "while"
...
token_T* lexer_collect_id(lexer_T* lexer) {
    ...
    if (strcmp(value, "Suck!") == 0)
        return init_token(TOKEN_VAR, value);
    else if (strcmp(value, "Hey, what your name?") == 0)
        return init_token(TOKEN_IF, value);
    else if (strcmp(value, "Who you with?") == 0)
        return init_token(TOKEN_ELSE, value);
    else if (strcmp(value, "Uh, you mean to the restroom?") == 0)
